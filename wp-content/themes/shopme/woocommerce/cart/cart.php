							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td data-title="<?php esc_html_e('Product Name', 'shopme') ?>">
									...
									if ( ! $product_permalink ) {
										...
										echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a class="product_title" href="%s">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key );
									}
