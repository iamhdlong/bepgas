...
function shopme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus5/shopme-content-types.zip' : '',
			'required'           => false,
			'version'            => '1.0.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus5/indeed-smart-popup.zip' : '',
			'required'           => false,
			'version'            => '4.6',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'LayerSlider WP',
			'slug'               => 'LayerSlider',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus5/LayerSlider.zip' : '',
			'required'           => false,
			'version'            => '6.6.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => ( $check_token ) ? 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus5/revslider.zip' : '',
			'required'           => false,
			'version'            => '5.4.5.1',
			'force_activation'   => false,
			'force_deactivation' => false
